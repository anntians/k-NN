...
public class TrainingJobRouterTransportAction extends HandledTransportAction<TrainingModelRequest, TrainingModelResponse> {
    ...
    protected void getTrainingIndexSizeInKB(TrainingModelRequest trainingModelRequest, ActionListener<Integer> listener) {
        ...
        client.search(countRequest, ActionListener.wrap(searchResponse -> {
            ...
            MethodComponentContext encoderContext = (MethodComponentContext) trainingModelRequest.getKnnMethodContext().getMethodComponentContext().getParameters().get(METHOD_ENCODER_PARAMETER);
            ...
            if(trainingModelRequest.getKnnMethodContext().getMethodComponentContext().getParameters().containsKey(METHOD_PARAMETER_NLIST)
                ...
                int nlist = ((Integer) trainingModelRequest.getKnnMethodContext().getMethodComponentContext().getParameters().get(METHOD_PARAMETER_NLIST));
