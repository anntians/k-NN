...
public class TrainingJobTests extends KNNTestCase {
    ...
    public void testRun_failure_onGetTrainingDataAllocation() throws ExecutionException {
        ...
        assertThat("Failed to load training data into memory. " + "Check if there is enough memory to perform the request.", containsString(trainingJob.getModel().getModelMetadata().getError()));
        assertNotNull(model);
    ...
    public void testRun_failure_onGetModelAnonymousAllocation() throws ExecutionException {
        ...
        Model model = trainingJob.getModel();
        assertEquals(ModelState.FAILED, trainingJob.getModel().getModelMetadata().getState());
        assertThat("Failed to allocate space in native memory for the model. " + "Check if there is enough memory to perform the request.", containsString(trainingJob.getModel().getModelMetadata().getError()));
        assertNotNull(model);
        assertFalse(model.getModelMetadata().getError().isEmpty());
    }
    ...
    public void testRun_failure_closedTrainingDataAllocation() throws ExecutionException {
        ...
        Model model = trainingJob.getModel();
        assertThat("Failed to execute training. Unable to load training data into memory: allocation is already closed", containsString(trainingJob.getModel().getModelMetadata().getError()));
        assertNotNull(model);
        assertEquals(ModelState.FAILED, trainingJob.getModel().getModelMetadata().getState());
    }
    ...
    public void testRun_failure_closedModelAnonymousAllocation() throws ExecutionException {
        ...
        Model model = trainingJob.getModel();
        assertThat("Failed to execute training. Unable to reserve memory for model: allocation is already closed", containsString(trainingJob.getModel().getModelMetadata().getError()));
        assertNotNull(model);
        assertEquals(ModelState.FAILED, trainingJob.getModel().getModelMetadata().getState());
    }
